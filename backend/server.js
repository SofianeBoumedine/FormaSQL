...
// Un driver de base de données est un logiciel qui permet à une application de communiquer avec une base de données
const db = mysql.createConnection({
  host: "localhost", // Adresse du serveur de base de données
  user: "root", // Nom d'utilisateur MySQL
  password: "sboumedine", // Mot de passe MySQL (à remplacer par votre mot de passe)
  database: "frigo_recettes", // Nom de la base de données
});

// Établissement de la connexion à MySQL
// Cette étape vérifie si la connexion à la base de données est réussie
db.connect((err) => {
  if (err) {
